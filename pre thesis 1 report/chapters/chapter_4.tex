...
calibration fold (Chapter 5 \S Implementation Details; drawn from the
training splits of FEVER, TriviaQA, and Natural Questions, disjoint
from the evaluation fold $n_{\text{eval}}$ that Chapter 5 reports
...
thresholds on the calibration fold rather than on the evaluation
fold is a deliberate disjointness guarantee: a quantile tuned on the
fold that later evaluates metrics would constitute peeking at the

...
\begin{tikzpicture}[
  ...
  fork/.style={diamond, aspect=2.6, draw=cbPitfall!75!black, fill=cbPitfall!10,
    line width=1pt, align=center, inner sep=1pt, font=\scriptsize, text width=3.2cm},
  ...
  \node[fork] (g) at (-3.6,2.9) {retention\\guard\\{\scriptsize worst probe $\ge 0.93$?}};
  ...
  \node[bnd, text width=2.4cm, fill=cbInk!6, draw=cbInk!55] (revert) at (-6.0,2.9) {roll back to\\last good adapter};

...
\begin{tikzpicture}[
  ...
  \draw[flow, draw=cbInk!55, dashed] (json.south) -- ++(0,-0.5) -| (apply.north)
    node[pos=0.25, above, font=\scriptsize, text=cbInk!60] {load frozen curves + weights};
\end{tikzpicture}}
...
\begin{tikzpicture}[
  font=\small\sffamily,
  dec/.style={diamond, aspect=2.8, draw=cbFormula!75!black, fill=cbFormula!10,
    line width=1pt, align=center, inner sep=1pt, font=\footnotesize, text width=3.0cm},
  ...
  \node[dec, draw=cbPitfall!75!black, fill=cbPitfall!10] (ee) at (0,3.2)
    {early-exit?\\{\scriptsize $\uint{\ge}0.70 \wedge$\\[-1pt]$\pgmax{\le}0.20$}};

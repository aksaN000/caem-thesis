...
\begin{tikzpicture}[font=\small\sffamily]
  ...
  \begin{scope}[xshift=0cm]
    \node[font=\bfseries\sffamily, text=cbPitfall!75!black] at (1.6,4.6) {Unstable reading};
    \node[font=\scriptsize, text=cbInk!70] at (1.6,4.2) {early layers scattered $\Rightarrow$ high $c_{\text{conv}}$};
  ...
  \begin{scope}[xshift=6.2cm]
    \node[font=\bfseries\sffamily, text=cbExample!60!black] at (1.6,4.6) {Stable reading};
    \node[font=\scriptsize, text=cbInk!70] at (1.6,4.2) {late layers tight $\Rightarrow$ low $c_{\text{conv}}$};

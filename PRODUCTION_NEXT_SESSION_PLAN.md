...
- [ ] **A.2.1** Write `docs/PANEL_DEMO_SCRIPT.md` with 5-7 questions exercising: verified answer, deferred answer, refusal (ABSTAIN), refusal (DISCARD), memory hit if available, safety override on out-of-domain query.
